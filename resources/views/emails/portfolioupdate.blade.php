                                                        ...
                                                        <tr>
                                                            <td style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';max-width:100vw;padding:32px">
                                                                ...
                                                                <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                                    Thank you subscribing to ‘View Our Portfolio’ service.
                                                                    <br>
                                                                    Below table shows today’s transactions in our portfolio. The same has been updated on our website. You may login and view today’s transactions on our website.
                                                                </p>

                                                                <!-- table here -->
                                                                <div style="display: block; width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch;">
                                                                    <table style="width: 100%; margin-bottom: 1rem; color: #212529; background-color: #b0d4f1; text-align: center !important;">
                                                                        <thead>
                                                                            <tr style="background-color: #343a40 !important; color: #f8f9fa !important;">
                                                                        ...
                                                                        <tbody style="border: 1px solid #dee2e6 !important;">
                                                                            <tr>
                                                                                <td> {{ $company_name}} </td>
